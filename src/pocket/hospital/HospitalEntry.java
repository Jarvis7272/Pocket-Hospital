 ...
 * @author aahir
 */
public class HospitalEntry extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        heading.setText("Hospital Entry Portal");
        ...
        jPanel1.add(pin_entry, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 160, 30));
        ...
        jPanel1.add(hos_entry, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 160, 30));
        ...
        jScrollPane1.setViewportView(hos_table);
        if (hos_table.getColumnModel().getColumnCount() > 0) {
            hos_table.getColumnModel().getColumn(0).setResizable(false);
            hos_table.getColumnModel().getColumn(1).setResizable(false);
            hos_table.getColumnModel().getColumn(2).setResizable(false);
            hos_table.getColumnModel().getColumn(3).setResizable(false);
            hos_table.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        ...
        try {
            ...
            String hos = hos_entry.getText();
            String pin = pin_entry.getText();
            String label1 = (String) state.getSelectedItem();
            String contact = contact_entry.getText();
            pst = conn.prepareStatement("UPDATE doctor set HOSPITAL=?,PIN=?, STATE=?, CONTACT=? where ID=?");
    ...
    private void search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_btnActionPerformed
        ...
        try {
            pst = conn.prepareStatement("Select ID,HOSPITAL,PIN,STATE,CONTACT from hospital where ID=?");
            ...
            if (rs.next() == false) {
                ...
                hos_entry.setText(rs.getString("doctor"));
                pin_entry.setText(rs.getString("spec"));
    ...
    private void insert_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_btnActionPerformed
        ...
        try {
            ...
            String hospital = hos_entry.getText();
            String pin = pin_entry.getText();
            String label1 = (String) state.getSelectedItem();
            String contact = contact_entry.getText();
            pst = conn.prepareStatement("INSERT into hospital(HOSPITAL,PIN,STATE,CONTACT) values(?,?,?,?)");
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
        ...
        try {
            ...
            String id = no_entry.getText();
            pst = conn.prepareStatement("DELETE from hospital where ID=?");
            pst.setString(1, id);
            pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HospitalEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField hos_entry;
    ...
    private javax.swing.JTextField pin_entry;
